...
def process_arguments():
    parser = argparse.ArgumentParser(description="Forza Horizon 5 UDP server test utility")
    parser.add_argument("--ip", metavar="IP address", help="The listening IP address (default: 127.0.0.1)")
...
def main():
    ...
    print("UDP server running and listening on {ip}:{port}".format(ip=ip, port=port))
